    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firebaseAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null){
                    startActivity(new Intent(PassengerLoginActivity.this, PassengerMapActivity.class));
                    finish();
                }
            }
        };
        ...
        Button mSignUp = findViewById(R.id.signup_btn);
        Button mSignIn = findViewById(R.id.signin_btn);
                ...
                mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(PassengerLoginActivity.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (!task.isSuccessful()){
                            ...
                            DatabaseReference user_db = FirebaseDatabase.getInstance().getReference().child(FirebaseEndPoints.USERS).child(FirebaseEndPoints.PASSENGERS).child(userId);
